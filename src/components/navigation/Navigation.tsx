        ...
        <div className="hidden lg:flex items-center gap-8">
          {navLinks.map((link) => (
            <a key={link.href} href={link.href} className="relative group">
              ...
              {/* Active indicator */}
              <span
                className={`absolute -bottom-2 left-0 right-0 h-0.5 bg-gray-900 dark:bg-white transition-all duration-500 ease-in-out ${
            ...
            {isLanguageMenuOpen && (
              <div className="absolute top-full right-0 mt-2 w-32 bg-white dark:bg-gray-900 rounded-lg shadow-lg border border-gray-200 dark:border-gray-800 py-2 overflow-hidden">
                <button
                  ...
                  className={`w-full px-4 py-2 text-left text-sm hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors flex items-center justify-between ${
                    language === "es"
